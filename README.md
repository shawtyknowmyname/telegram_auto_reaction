...
- **API ID и API HASH** — можно получить на [my.telegram.org](https://my.telegram.org/auth):
  ...
  > 🔑 **Как получить:**
  > Авторизуйтесь на сайте [my.telegram.org](https://my.telegram.org/auth) с помощью вашего номера Telegram и кода подтверждения.
  ...
  > Скопируйте выданные **API ID** и **API HASH**
